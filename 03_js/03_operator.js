...
console.log(1 === 1); // true
console.log(1 === "1"); // 형변환을 거치지 않기 때문에 false로 판단한다.
console.log(1 === true);
console.log(0 === false);

// 부정(!) : true => false, false => true로 바꾼다.
...
/*
    논리 연산자
       ...
       - !(not), or(||), &&(and)
       - or : 피연산자 중 하나라도 true일시 => true, 모두 false면 false.
       - and : 피연산자 모두가 true일 때만 true. 즉, 하나라도 false면 false.
*/
var user02 = {
  gender: "male",
  age: 30,
...
var isTrue = user02.name === "Son" && user02.age >= 30;
